...
export default function SignInPage() {
  ...
  return (
    <main className="min-h-screen flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-[480px] bg-surface rounded-xl shadow-2xl p-8 md:p-10 flex flex-col gap-8">
        ...
        <div className="flex flex-col items-center gap-4 border-t border-border pt-6">
          ...
          <p className="font-sans text-xs text-text-secondary text-center px-4">
            Strictly for authorized logistics personnel and fleet managers in
            Cameroon.
          </p>
        </div>
      </div>
