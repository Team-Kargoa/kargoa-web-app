        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 text-lg max-w-3xl mx-auto">
              Finding trusted transporters, tracking shipments, and managing deliveries shouldn't be difficult.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <div className="bg-green-50 rounded-3xl p-8">
              ...
              <p className="text-lg text-gray-700 leading-relaxed">
                Kargoa connects individuals, drivers, and companies
                into one digital platform where deliveries can be booked,
                tracked, and managed from start to finish.
              </p>
            </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div className="bg-white p-8 rounded-3xl shadow-sm">
              <div className="text-4xl mb-4"><Package size={24} color="#b45309" fill="#fde68a"  /></div>
            ...
            <div className="bg-white p-8 rounded-3xl shadow-sm">
              <div className="text-4xl mb-4"><Van size={24} color="#1d4ed8" fill="#dbeafe"/></div>
              <h3 className="font-bold text-xl mb-3">
                Get Matched
              </h3>
              <p className="text-gray-600">
            ...
            <div className="bg-white p-8 rounded-3xl shadow-sm">
              <div className="text-4xl mb-4"><MapPin size={24} color="#ef4444"/></div>
              <h3 className="font-bold text-xl mb-3">
                Track Live
              </h3>
              <p className="text-gray-600">
            ...
            <div className="bg-white p-8 rounded-3xl shadow-sm">
              <div className="text-4xl mb-4"><Check size={24} color="green"/></div>
              <h3 className="font-bold text-xl mb-3">
                Delivered
              </h3>
              <p className="text-gray-600">
      ...
      <section className="bg-black text-white py-28 px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-300 mb-10">
            Join businesses and drivers using Kargoa to simplify logistics across Cameroon.
          </p>
